...
func (*PasswordResetToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case passwordresettoken.FieldEmail, passwordresettoken.FieldTokenHash:
			values[i] = new(sql.NullString)
		case passwordresettoken.FieldExpiresAt, passwordresettoken.FieldConsumedAt, passwordresettoken.FieldCreatedAt:
