...
func (_c *PasswordResetTokenCreate) SetConsumedAt(v time.Time) *PasswordResetTokenCreate {
	_c.mutation.SetConsumedAt(v)
	return _c
}

// SetNillableConsumedAt sets the "consumed_at" field if the given value is not nil.
func (_c *PasswordResetTokenCreate) SetNillableConsumedAt(v *time.Time) *PasswordResetTokenCreate {
	if v != nil {
		_c.SetConsumedAt(*v)
	}
	return _c
...
func (_c *PasswordResetTokenCreate) SetUserID(id int) *PasswordResetTokenCreate {
